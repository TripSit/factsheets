var drawChartsDark = function drawChartsDark() {
  ...
  if(drug && drug.formatted_dose) {
    $.each(drug.formatted_dose, function(roa, levels) {
      ...
      var layout = {
        barmode: 'group', 
        title: title,
        yaxis: { title: 'Dose ('+u+')', color: "#D9D9D9", linecolor: "#D9D9D9", gridcolor: "#D9D9D9", zeroline: "#D9D9D9" },
        xaxis: { title: 'Experience Level', color: "#D9D9D9"},
        plot_bgcolor: "#1f2127",
        paper_bgcolor: "#1f2127",
        font: { color: "#D9D9D9"},
      };
